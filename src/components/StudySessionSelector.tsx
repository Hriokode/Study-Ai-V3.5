    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <Card className="glass-card p-6 mb-8 animate-fadeInUp">
            ...
            <div className="max-w-md mx-auto">
              <Label htmlFor="study-topic" className="text-sm font-semibold text-gray-700 mb-2 block">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className={`p-3 rounded-full bg-gradient-to-r ${template.color} shadow-lg`}>
                        <IconComponent className="h-6 w-6 text-white" />
                      </div>
                      <div className="text-right">
                        <Badge className={`${getTypeColor(template.type)} border font-semibold`}>
                          {template.type}
                        </Badge>
                    ...
                    {/* Study Tips */}
                    <div className="mb-6">
                      <h4 className="text-sm font-semibold text-gray-700 mb-3">Study Tips:</h4>
                    ...
                    {template.phases && (
                      <div className="mb-6">
                        <h4 className="text-sm font-semibold text-gray-700 mb-3">Session Phases:</h4>
                    ...
                    <Button
                      ...
                      className={`w-full bg-gradient-to-r ${template.color} hover:shadow-lg text-white font-semibold py-3 transform hover:scale-105 transition-all duration-300`}
                    >
          ...
          {/* Additional Features */}
          <Card className="glass-card p-6 mt-8 animate-fadeInUp" style={{animationDelay: '0.8s'}}>
            <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-800 mb-2">Background Timer</h4>
